...
<head>
	...
	<title><?php print $_SESSION['__config__']['intestazione_scuola'] ?>:: comuicazioni dei rappresentanti di classe</title>
...
<div id="main">
	...
	<div id="left_col">
		<div style="top: 75px; margin-left: 625px; margin-bottom: 10px; position: absolute" class="rb_button">
			<a href="class_message.php?idm=0">
		...
		<div class="card_container" style="margin-top: 15px">
			...
			if($result->num_rows < 1){
				?>
				<div style="text-align: center; font-weight: bold; width: 90%; margin: auto; font-size: 1.1em">Nessuna comunicazione presente</div>
				...
				while ($message = $result->fetch_assoc()){
					?>
					<div class="card" id="row_<?php echo $message['id_messaggio'] ?>">
						<div class="card_title">
							<?php echo truncateString($message['oggetto'], 90) ?>
							<div id="menu_<?php echo $message['id_circolare'] ?>" style="width: 20px; float: right; margin-right: 0">
						...
						<div class="card_varcontent" style="overflow: hidden">
							<div class="card_row">
								Circolare n. <?php echo $message['progressivo'] ?> del <?php echo format_date ($message['data_messaggio'], SQL_DATE_STYLE, IT_DATE_STYLE, "/") ?>
							</div>
							<div class="minicard">
								Inserita da <?php echo $message['nome']." ".$message['cognome'] ?>
							</div>
						</div>
					</div>
					<?php
...
<a href="class_message.php?idm=0" id="float_btn" class="rb_button float_button">
