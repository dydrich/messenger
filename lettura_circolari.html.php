...
<div id="main">
	...
	?>
		<div style="overflow: hidden; border-bottom: 1px solid #EEEEEE">
			<div style="width: 50%; float: left"><?php echo $read['cognome']." ".$read['nome'] ?></div>
			<div style="width: 49%; float: right"><?php if ($read['letta'] == 1) echo "Letta il ".$read['data_lettura'] ; else echo "<span class='attention' style='font-weight: bold'>NON LETTA</span>" ?></div>
		</div>
	<?php
		$x++;
